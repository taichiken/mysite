  ...
  <div class="py-3 bg-dark">
    <div class="pe-3 text-right">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="calendar.php">タイムカード</a></li>
      </ul>
    </div>
    ...
    <div class="row g-3">
      <div class="col">
        <div class="p-5 text-center">
          <button type="submit" class="btn btn-outline-success kintai-btn" name="action" value="1">出勤</button>
        </div>
      </div>
      <div class="col">
        <div class="p-5 text-center">
          <button type="submit" class="btn btn-outline-danger kintai-btn" name="action" value="2">退勤</button>
        </div>
      </div>
    </div>
    <!--ボタン押下時に後続処理に引き渡す-->
